...
public class ItemSunResult extends RecyclerView.Adapter<ItemSunResult.MyViewHolder> {
    ...
    public ItemSunResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemSunResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_sun, parent, false);
        return new ItemSunResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_sun_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_sun_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_sun_time);
            mTimeStart= (TextView) itemView.findViewById(R.id.tv_item_sun_timestart);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_sun_icon);
            mImagColor= (ImageView) itemView.findViewById(R.id.iv_item_sun_priority);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_sun_mask);
