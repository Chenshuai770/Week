...
import com.cs.week.modle.adpter.ItemWedResult;
...
public class WedFragment extends BaseFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fm_wed, container, false);
        initView(view);
        initData();
    ...
    private void initData() {
        mList.clear();
        List<DateSqlListResult> data = DataSupport.where("flag=?","3").find(DateSqlListResult.class);
        mList.addAll(data);
    ...
    private void initView(View view) {
        mRecyclerView= (RecyclerView) view.findViewById(R.id.rl_wed);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        mRecyclerView.setLayoutManager(layoutManager);
        adapter= new ItemWedResult(getContext(),mList);
        mRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickLitener(new ItemWedResult.OnItemClickLitener() {
            @Override
