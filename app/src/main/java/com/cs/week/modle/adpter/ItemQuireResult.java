...
public class ItemQuireResult extends RecyclerView.Adapter<ItemQuireResult.MyViewHolder> {
    ...
    public ItemQuireResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemQuireResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_quire, parent, false);
        return new ItemQuireResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_quire_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_quire_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_quire_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_quire_icon);
            mImagColor= (ImageView) itemView.findViewById(R.id.iv_item_quire_priority);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_quire_mask);
            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_quire_timestart);
        }
    }
