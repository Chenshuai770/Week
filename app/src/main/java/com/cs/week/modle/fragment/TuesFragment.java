...
import com.cs.week.modle.adpter.ItemTuesResult;
...
public class TuesFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private ItemTuesResult adapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fm_tues, container, false);
        initView(view);
        initData();
    ...
    private void initData() {
        mList.clear();
        List<DateSqlListResult> data = DataSupport.where("flag=?","2").find(DateSqlListResult.class);
        mList.addAll(data);
    ...
    private void initView(View view) {
        mRecyclerView= (RecyclerView) view.findViewById(R.id.rl_tues);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        mRecyclerView.setLayoutManager(layoutManager);
        adapter= new ItemTuesResult(getContext(),mList);
        mRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickLitener(new ItemTuesResult.OnItemClickLitener() {
            @Override
