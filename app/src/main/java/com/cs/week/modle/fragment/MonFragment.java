...
import com.cs.week.modle.adpter.ItemMonResult;
...
public class MonFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private ItemMonResult adapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fm_mon, container, false);
        initView(view);
        initData();
    ...
    private void initData() {
        mList.clear();
        List<DateSqlListResult> data = DataSupport.where("flag=?","1").find(DateSqlListResult.class);
        mList.addAll(data);
    ...
    private void initView(View view) {
        mRecyclerView= (RecyclerView) view.findViewById(R.id.rl_mon);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        mRecyclerView.setLayoutManager(layoutManager);
        adapter= new ItemMonResult(getContext(),mList);
        mRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickLitener(new ItemMonResult.OnItemClickLitener() {
            @Override
