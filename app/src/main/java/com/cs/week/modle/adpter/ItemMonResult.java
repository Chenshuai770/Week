...
public class ItemMonResult extends RecyclerView.Adapter<ItemMonResult.MyViewHolder> {
    ...
    public ItemMonResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemMonResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_mon, parent, false);
        return new ItemMonResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_mon_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_mon_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_mon_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_mon_icon);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_mon_mask);
            mImagColor= (ImageView) itemView.findViewById(R.id.iv_item_mon_priority);
            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_mon_timestart);
