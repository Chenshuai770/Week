 ...
 * data：16/7/27
 */
public class ItemListCompleteAdapter extends
        RecyclerView.Adapter<ItemListCompleteAdapter.ViewHolder> {
    ...
    public ItemListCompleteAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_list_compelet,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.baoxiu_photo);
