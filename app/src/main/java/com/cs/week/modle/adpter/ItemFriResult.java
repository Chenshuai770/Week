...
public class ItemFriResult extends RecyclerView.Adapter<ItemFriResult.MyViewHolder> {
    ...
    public ItemFriResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemFriResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_fri, parent, false);
        return new ItemFriResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_fri_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_fri_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_fri_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_fri_icon);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_fri_mask);
            mImagColor = (ImageView) itemView.findViewById(R.id.iv_item_fri_priority);
            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_fri_timestart);
