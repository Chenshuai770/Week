...
import com.cs.week.modle.adpter.ItemSatResult;
...
public class SatFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private ItemSatResult adapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fm_sat, container, false);
        initView(view);
        initData();
    ...
    private void initData() {
        mList.clear();
        List<DateSqlListResult> data = DataSupport.where("flag=?","6").find(DateSqlListResult.class);
        mList.addAll(data);
    ...
    private void initView(View view) {
        mRecyclerView= (RecyclerView) view.findViewById(R.id.rl_sat);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        mRecyclerView.setLayoutManager(layoutManager);
        adapter=new ItemSatResult(getContext(),mList);
        mRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickLitener(new ItemSatResult.OnItemClickLitener() {
            @Override
