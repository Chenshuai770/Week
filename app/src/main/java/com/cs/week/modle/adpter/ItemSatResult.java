...
public class ItemSatResult extends RecyclerView.Adapter<ItemSatResult.MyViewHolder> {
    ...
    public ItemSatResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemSatResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_sat, parent, false);
        return new ItemSatResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_sat_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_sat_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_sat_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_sat_icon);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_sat_mask);
            mImagColor = (ImageView) itemView.findViewById(R.id.iv_item_sat_priority);
            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_sat_timestart);
