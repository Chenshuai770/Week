...
public class ItemTuesResult extends RecyclerView.Adapter<ItemTuesResult.MyViewHolder> {
    ...
    public ItemTuesResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemTuesResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_tues, parent, false);
        return new ItemTuesResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_tues_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_tues_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_tues_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_tues_icon);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_tues_mask);

            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_tues_timestart);

            mImagColor= (ImageView) itemView.findViewById(R.id.iv_item_tues_priority);
