...
public class ItemWedResult extends RecyclerView.Adapter<ItemWedResult.MyViewHolder> {
    ...
    public ItemWedResult(Context context, List<DateSqlListResult> mList) {
        this.context = context;
        this.mList = mList;
    }

    @Override
    public ItemWedResult.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_list_wed, parent, false);
        return new ItemWedResult.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            mTitle= (TextView) itemView.findViewById(R.id.tv_item_wed_title);
            mContent= (TextView) itemView.findViewById(R.id.tv_item_wed_content);
            mTime= (TextView) itemView.findViewById(R.id.tv_item_wed_time);
            mImagView= (ImageView) itemView.findViewById(R.id.iv_item_wed_icon);
            mTask= (LinearLayout) itemView.findViewById(R.id.ll_task_wed_mask);
            mImagColor = (ImageView) itemView.findViewById(R.id.iv_item_wed_priority);
            mTimeStart = (TextView) itemView.findViewById(R.id.tv_item_wed_timestart);
