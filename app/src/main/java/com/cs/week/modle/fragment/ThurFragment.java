...
import com.cs.week.modle.adpter.ItemThurResult;
...
public class ThurFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    private ItemThurResult adapter;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fm_thur, container, false);
        initView(view);
        initData();
    ...
    private void initData() {
        mList.clear();
        List<DateSqlListResult> data = DataSupport.where("flag=?","4").find(DateSqlListResult.class);
        mList.addAll(data);
    ...
    private void initView(View view) {
        mRecyclerView= (RecyclerView) view.findViewById(R.id.rl_thur);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false);
        mRecyclerView.setLayoutManager(layoutManager);
        adapter= new ItemThurResult(getContext(),mList);
        mRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickLitener(new ItemThurResult.OnItemClickLitener() {
            @Override
